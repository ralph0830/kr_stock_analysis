...
### frontend/src/app/dashboard/kr/page.tsx (kr_stock_analysis/frontend/src/app/dashboard/kr/page.tsx)
```tsx
'use client';
...
### frontend/src/app/dashboard/kr/closing-bet/page.tsx (kr_stock_analysis/frontend/src/app/dashboard/kr/closing-bet/page.tsx)
```tsx
'use client';
...
### frontend/src/lib/api.ts (kr_stock_analysis/frontend/src/lib/api.ts)
```typescript
