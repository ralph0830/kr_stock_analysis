...
### frontend/src/app/globals.css (kr_stock_analysis/frontend/src/app/globals.css)
```css
@import "tailwindcss";
...
### chatbot/core.py (kr_stock_analysis/chatbot/core.py)
```python
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
    ...
    def __init__(
        ...
        if GEMINI_AVAILABLE and self.api_key:
            try:
                ...
                raise ValueError("Gemini API key is required for chatbot functionality")
        else:
...
### chatbot/prompts.py (kr_stock_analysis/chatbot/prompts.py)
```python
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
