...
### engine/generator.py (kr_stock_analysis/engine/generator.py)
```python
"""
시그널 생성기 (Main Engine)
- Collector로부터 데이터 수집
...
### engine/llm_analyzer.py (kr_stock_analysis/engine/llm_analyzer.py)
```python
"""
...
### engine/config.py (kr_stock_analysis/engine/config.py)
```python
"""
종가베팅 시그널 생성기 설정
"""
